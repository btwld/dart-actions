...
jobs:
  ci:
    uses: your-org/dart-actions/.github/workflows/ci.yml@main
    secrets:
...
jobs:
  pr-title-check:
    uses: your-org/dart-actions/.github/workflows/pr-title-check.yml@main
```
...
jobs:
  publish:
    uses: your-org/dart-actions/.github/workflows/publish.yml@main
    with:
